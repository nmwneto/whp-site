...
const teamMembers = [
  {
    ...
    bio: 'Lidera a visão criativa e estratégica de cada projeto com mais de 10 anos de experiência em branding e inovação digital.',
    image: 'https://i.pravatar.cc/300?img=8',
    accentColor: '#0071e3',
    spotlightColor: 'rgba(0, 113, 227, 0.25)',
    social: { label: '@membro1', url: 'https://instagram.com/' },
  },
  {
    name: 'Nome Membro 2',
    role: 'Web Developer',
    bio: 'Especialista em performance e experiências web de alto impacto com foco em tecnologia de ponta e código limpo.',
    image: 'https://i.pravatar.cc/300?img=11',
    accentColor: '#34c759',
    spotlightColor: 'rgba(52, 199, 89, 0.25)',
    social: { label: '@membro2', url: 'https://instagram.com/' },
  },
  {
    name: 'Nome Membro 3',
    role: 'UI/UX Designer',
    bio: 'Transforma complexidade em interfaces intuitivas e visualmente memoráveis que encantam e convertem.',
    image: 'https://i.pravatar.cc/300?img=3',
    accentColor: '#ff9f0a',
    spotlightColor: 'rgba(255, 159, 10, 0.25)',
    social: { label: '@membro3', url: 'https://instagram.com/' },
  },
  {
    name: 'Nome Membro 4',
    role: 'Social Media & SEO',
    bio: 'Conecta marcas ao público certo com estratégias de conteúdo e otimização orientadas a dados e resultados.',
    image: 'https://i.pravatar.cc/300?img=16',
    accentColor: '#bf5af2',
    spotlightColor: 'rgba(191, 90, 242, 0.25)',
    social: { label: '@membro4', url: 'https://instagram.com/' },
  },
];
