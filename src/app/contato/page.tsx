...
export default function ContatoPage() {
  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-[1100px]">
          <div className="grid gap-4" style={{ gridTemplateColumns: 'repeat(4, 1fr)' }}>
            {contactChannels.map((ch) => (
              <a key={ch.title} href={ch.href} target={ch.href.startsWith('http') ? '_blank' : undefined} rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
                <SpotlightCard spotlightColor={ch.spotlight} className="services-card" style={{ height: '100%' }}>
      ...
      >
        <div className="mx-auto max-w-[1000px]" style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '5rem', alignItems: 'start' }}>
          {/* Form */}
          <div>
          ...
          {/* Info sidebar */}
          <div>
            <h3 className="text-lg font-semibold text-white" style={{ marginBottom: '1.5rem' }}>
              Informações
            </h3>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
              ...
              >
                <p style={{ fontSize: '0.875rem', fontWeight: 500, color: 'rgba(255,255,255,0.5)', lineHeight: 1.7 }}>
                  <span style={{ color: '#fff', fontWeight: 600 }}>Prefere conversar diretamente?</span><br />
                  Agende uma call de 15 minutos sem compromisso pelo WhatsApp.
                </p>
                <a
                  href="https://wa.me/"
                  target="_blank"
