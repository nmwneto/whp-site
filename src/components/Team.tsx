...
const teamMembers = [
  {
    ...
    bio: 'Lidera a visão criativa e estratégica de cada projeto com mais de 10 anos de experiência em branding.',
  ...
  },
  {
    name: 'Nome Membro 2',
    role: 'Web Developer',
    bio: 'Especialista em performance e experiências web de alto impacto com foco em tecnologia de ponta.',
  ...
  },
  {
    name: 'Nome Membro 3',
    role: 'UI/UX Designer',
    bio: 'Transforma complexidade em interfaces intuitivas e visualmente memoráveis para cada marca.',
