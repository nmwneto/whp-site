...
const serviceHrefs = [
  '/servicos/identidade-de-marca',
  '/servicos/web-design-e-dev',
  '/servicos/seo-e-conteudo',
  '/servicos/social-media-e-performance',
...
export default function Services() {
  ...
  const serviceData = t.services.items.map((item, i) => ({
    ...item,
    href: serviceHrefs[i],
    icon: icons[i],
